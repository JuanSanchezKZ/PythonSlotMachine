...
class Reel:
    def __init__(self, pos):
        ...
        self.shuffled_keys = self.shuffled_keys[
            :5
        ]  # Only matters when there are more than 5 symbols
...
class Symbol(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.fade_in and not self.fade_out:
            if self.size_x < 320:
                self.size_x += 1
                self.size_y += 1
        ...
        # Fades out non-winning symbols
            ...
            if self.alpha > 115:
                ...
                # Apply blur effect
                # Replace with your condition to decide when to apply the blur
